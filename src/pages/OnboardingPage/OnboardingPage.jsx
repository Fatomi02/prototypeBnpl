...
import { FaArrowLeft, FaArrowRight, FaUser, FaIdCard, FaUniversity } from 'react-icons/fa'
...
const OnboardingPage = () => {
  ...
  const { onboardingStep, updateOnboardingStep, login, completeOnboarding } = useUserStore()
      ...
      <div className="onboarding-page__sidebar">
        ...
        <div className="onboarding-page__steps">
          {steps.filter(step => step.id < 4).map((step) => (
            <div 
              key={step.id}
              className={`onboarding-page__step ${onboardingStep >= step.id ? 'onboarding-page__step--active' : ''}`}
            >
              <div className="onboarding-page__step-indicator">
                <div className="onboarding-page__step-icon">
                  {step.icon}
                </div>
        ...
        <div className="onboarding-page__help">
          <h3>Need Help?</h3>
          <p>Contact our support team at <a href="mailto:support@bnplapp.com">support@bnplapp.com</a></p>
        </div>
      </div>
      ...
      <div className="onboarding-page__content">
        ...
        <div className="onboarding-page__main">
          <AnimatePresence mode="wait">
            <Routes>
              <Route path="/" element={<Navigate to="/onboarding/personal-info" replace />} />
              <Route 
                path="/personal-info" 
                element={
                  <motion.div
        ...
        <div className="onboarding-page__footer">
          <p>© 2025 BNPL App. By continuing, you agree to our <a href="#">Terms & Conditions</a> and <a href="#">Privacy Policy</a>.</p>
        </div>
      </div>
    </div>
  )
